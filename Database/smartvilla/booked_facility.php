    ...
    <!-- start: Header -->
        ...
        <div class="row-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <a href="#">Booked Facility</a></li>
            </ul>

            <div class="row-fluid sortable">        
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white user"></i><span class="break"></span>Booked Facility</h2>
                        <div class="box-icon">
                    ...
                    <form action="#" method="post" name="fm" id="fm">
                        <table id="tbl" class="table table-striped table-bordered bootstrap-datatable datatable">
                          ...
                          <tbody>   
                            ...
                            <?php
                            $res =mysql_query("select * from tbl_society_facility_booking");
                            while($row=mysql_fetch_array($res))
                            { 
                            ?>
                            <tr>
                                <td><?php echo $row['s_facility_booking_id'];?></td>
