            ...
            <div class="row-fluid sortable">        
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white user"></i><span class="break"></span>Notices</h2>
                        <div class="box-icon">
                    ...
                    <form action="#" method="post" name="fm" id="fm">
                        <table id="tbl" class="table table-striped table-bordered bootstrap-datatable datatable">
                          ...
                          <tbody>
                            ...
                            <?php
                            $res =mysql_query("select * from tbl_noticeboard");
                            ...
                            <tr>
                                ...
                                <td style="width: 150px;">
                                    ...
                                    <a class="btn btn-info" href="noticeboard_info_o.php?eid=<?php echo $row['n_id']; ?>&menu=noticeboard">
                                        <i class="halflings-icon white edit"></i>                                            
                                    </a>
                                    <strong>|</strong>
                                    <a class="btn btn-danger" href="noticeboard_info.php?did=<?php echo $row['n_id']; ?>" onclick="return confirmdelete();">
                            ...
                            {
                                $res = delete('tbl_noticeboard','n_id',$_REQUEST['did']);
                                if($res)
                                {
