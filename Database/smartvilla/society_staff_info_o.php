...
<body>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
					<i class="icon-edit"></i>
					<a href="#">Society Staff Information</a>
				</li>
			</ul>
    ...
    {     
        ...
        $ins="insert into tbl_society_staff set  
                                  name='".$_REQUEST['name']."',
        ...
        if($res)
        {
            ...
            echo "<script>window.location='society_staff_info.php?menu=society_staff_info';</script>";
        }
        else
        {
...
?>
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>ADD NEW SOCIETY STAFF DETAILS</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" method="post" enctype="multipart/form-data">
						  <fieldset>
                            ...
                            <div class="controls">
                                <input type="text" class="span6 typeahead" id="id_proof_no" name="id_proof_no"  data-provide="typeahead" data-items="4" >
                                <!--<p class="help-block">Start typing to activate auto complete!</p> -->
                              </div>
                            </div>
                            ...
                            <div class="controls">
                                <input type="text" class="span6 typeahead" id="contact" name="contact"  data-provide="typeahead" data-items="4" required  maxlength="13">
                                <i id="errmsg_n"></i>
                                <!--<p class="help-block">Start typing to activate auto complete!</p> -->
                              </div>
  ...
  <!-- -------------------------------------------------------------------------------------------->          
            ...
            {
                $record = mysql_query("select * from tbl_society_staff where s_staff_id='".$_REQUEST['eid']."'");
                $res = mysql_fetch_array($record);
                if(isset($_REQUEST['edit']))
                {
                    
                    $b11=$_FILES['id_proof_image']['name'];
                if($b11!=NULL)
                {
                    $t1=$_FILES['id_proof_image']['tmp_name'];
                    $path1="image/".$b11;
                }
                else
                {
                ...
                $ins="update tbl_society_staff set  
                                  name='".$_REQUEST['name']."',
                                  id_proof='".$_REQUEST['id_proof']."',
                                  id_proof_image='".$path1."',
                                  id_proof_no='".$_REQUEST['id_proof_no']."',
                                  address='".$_REQUEST['address']."',
                                  reference='".$_REQUEST['reference']."',
                                  contact='".$_REQUEST['contact']."',
                                  work_type='".$_REQUEST['work_type']."',
                                  salary='".$_REQUEST['salary']."' where s_staff_id='".$_REQUEST['eid']."'";
        ...
        else
        {
            ...
            ?> 
                ...
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white edit"></i><span class="break"></span>EDIT SOCIETY STAFF DETAILS</h2>
                        <div class="box-icon">
                            <a href="#" class="btn-setting"><i class="halflings-icon white wrench"></i></a>
                            <a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
                            <a href="#" class="btn-close"><i class="halflings-icon white remove"></i></a>
                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                          <fieldset>
                           ...
                           <fieldset>
                            ...
                            <div class="controls">
                                <input type="text" class="span6 typeahead" id="salary" name="salary" value="<?php echo $res['salary'] ?>" data-provide="typeahead" data-items="4" data-source='["krunal","patel","payal","bhavni"]'>
                                <!--<p class="help-block">Start typing to activate auto complete!</p> -->
