...
<body>
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
                ...
                <li>
                    ...
                    <a href="index.php?menu=index">Clubhouse Members</a>
                    <i class="icon-angle-right"></i> 
                </li>
				<li>
					<i class="icon-edit"></i>
					<a href="#">Clubhouse Members Information</a>
				</li>
			</ul>
   ...
   {     
        ...
        $ins="insert into tbl_clubhouse_member set  
                                    
                                  s_member_name='".$_REQUEST['s_member_name']."',  
                                  clubhouse_facilities_name='".$_REQUEST['clubhouse_facilities_name']."',
        ...
        if($res)
        {
            ...
            echo "<script>window.location='clubhouse_members_info.php?menu=clubhouse_members_info';</script>";
        }
        else
        {
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>ADD NEW CLUBHOUSE MEMBER </h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" method="post" enctype="multipart/form-data">
						  <fieldset>
                            ...
                            <div class="controls">
                                <input type="text" class="span6 typeahead" id="s_member_name" name="s_member_name"  data-provide="typeahead" data-items="4" >
                            ...
                            <div class="control-group">
                              <label class="control-label" for="typeahead">Clubhouse Facility Name </label>
                            
                            <div class="controls">
                                <input type="text" class="span6 typeahead" id="clubhouse_facilities_name" name="clubhouse_facilities_name" data-provide="typeahead" data-items="4" >
                                <i id="errmsg"></i> 
                                <!--<p class="help-block">Start typing to activate auto complete!</p>-->
                              </div>
                            </div>
