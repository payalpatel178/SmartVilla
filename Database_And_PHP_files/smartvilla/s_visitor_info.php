		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><i class="fa fa-info-circle" aria-hidden="true"></i>
                    <a href="#">Society visitor details</a>
                   <!-- <i class="icon-angle-right"></i>-->
                </li>
			</ul>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Society visitor details</h2>
						<div class="box-icon">
                    ...
                    <form action="#" method="post" name="fm" id="fm">
                        <table id="tbl" class="table table-striped table-bordered bootstrap-datatable datatable">
                          ...
                          <tbody>
                            ...
                            <?php
                            $res =mysql_query("select * from tbl_society_visitor");
                            while($row=mysql_fetch_array($res))
                            { 
                            ?>
                            <tr>
                                <td><?php echo $row['s_visitor_id'];?></td>
