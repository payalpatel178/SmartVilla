			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Flats</h2>
						<div class="box-icon">
                    ...
                    <form action="#" method="post" name="fm" id="fm">
                        <table id="tbl" class="table table-striped table-bordered bootstrap-datatable datatable">
                          ...
                          <tbody>
                            ...
                            <?php
                            $res =mysql_query("select * from tbl_society_flats");
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['flat_location'];?></td>
                            ...
                            {
                                $res = delete('tbl_society_flats','s_flat_id',$_REQUEST['did']);
                                if($res)
                                {
