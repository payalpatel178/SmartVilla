    ...
    <!-- start: Header -->
        ...
        <div class="row-fluid">
            ...
            <ul class="breadcrumb">
               ...
               <li><a href="#">Society Member Details</a></li> 
            </ul>

            <div class="row-fluid sortable">        
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white user"></i><span class="break"></span>Society Member Details</h2>
                        <div class="box-icon">
                    ...
                    <form action="#" method="post" name="fm" id="fm">
                        <table id="tbl" class="table table-striped table-bordered bootstrap-datatable datatable">
                          ...
                          <a class="btn btn-info" href="s_member_info_o.php?new=1&menu=s_member_info">
                          ...
                          <tbody>
                            ...
                            <?php
                            $res =mysql_query("select * from tbl_s_member");
                            while($row=mysql_fetch_array($res))
                            { 
                            ?>
                            <tr>
                                <td><?php echo $row['s_member_id'];?></td>
                                <td><?php echo $row['s_flat_id'];?></td> 
                                ...
                                <td style="width: 150px;">
                                    ...
                                    <a class="btn btn-info" href="s_member_info_o.php?eid=<?php echo $row['s_member_id']; ?>&menu=society_staff_info">
                                        <i class="halflings-icon white edit"></i>                                            
                                    </a>
                                    <strong>|</strong>
                                        
                                    <a class="btn btn-danger" href="s_member_info.php?did=<?php echo $row['s_member_id']; ?>" onclick="return confirmdelete();">
                            ...
                            {
                                $res = delete('tbl_s_member','s_member_id',$_REQUEST['did']);
                                if($res)
                                {
